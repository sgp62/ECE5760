...
int main(void)
{
	...
	pio_eta_term_ptr = (unsigned int *)(vga_pixel_virtual_base + UPDATE_CYCLES);

	// *pio_num_rows_ptr = 0x7;
	// *pio_rho_ptr = 0x2000;
	// *pio_initial_amp_ptr = 0x11; // 17
	// *pio_g_tension_ptr = 0x6;
	// *pio_eta_term_ptr = 0xb;
